...
// router.get(     '/cuentas',             passport.authenticate('jwt', {session:false}), CuentasController.getAll); // R
// router.get(     '/cuentas',             passport.authenticate('jwt', {session:false}), CuentasController.get);    // R
